...
class C_MitraSTG extends CI_Controller {
	...
	public function index()
	{
		...
		$data = [
			'project'	=> $this->M_MitraSTG->get_stg($id)
		];
		$this->template->load('template_mitra', 'MitraSTG/data' , $data);
	}
