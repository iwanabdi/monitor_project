...
<div class="container-fluid">
  	...
  	<div class="card shadow mb-4">
	    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<h5 class="m-0 font-weight-bold text-primary">Create PO </h5>
				<div class="right">
    	...
    	<form action="<?= site_url('PO/buat_po')?>" method="POST">
	    	<div class="card-body">
				<div class="form-group row">
		          <label class="col-sm-3 col-form-label">No Purchase Request </label>
		          <div class="col-sm-9">
		            <div class="input-group">
		              <input type="text" class="form-control" name="pr_no" id="pr_no" readonly value="<?=$po->pr_no?>" required>
		            </div>
		          </div>
				</div>	
		        <div class="form-group row">
                ...
                <div class="form-group row">
		          ...
		          <div class="col-sm-9">
		            <div class="input-group">
		              <input type="date" class="form-control" name="devdate" id="devdate" value="<?=$po->devdate_pr?>" readonly required>
		            </div>
		          </div>
				</div>
                <div class="form-group row">
				<label class="col-sm-3 col-form-label">Pekerjaan dan Qty</label>
					<div class="col-sm-9">
						<table class="table ml-auto text-gray-800" id="tableLoop">
							...
							<tbody>
                            <?php
                            foreach ($dpr->result() as $key => $data)  {
                                // var_dump($data);
                                ?>
                                <tr>
                                    <td>
