      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <li class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
          	<h5>Selamat Datang <?php echo $this->session->userdata('Nama_Pegawai');?></h5>
          </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item no-arrow m-auto">
            	<h6>Role : <?php $jabatan = ucwords($this->session->userdata('Jabatan'));
            					if ($jabatan == 0) {
            						echo 'SPV Aktivasi';
            					}else if($jabatan == 1){
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Monitoring Project 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
