<div class="container-fluid">
  	...
  	<div class="card shadow mb-4">
	    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<h5 class="m-0 font-weight-bold text-primary">Form Testcom</h5>
			<div class="col-4">
		...
		<?php echo form_open_multipart('C_testcom/upload_file')?>
			<div class="form-group row">		       
		        ...
		        <div class="form-group row">
		          <label class="col-sm-3 col-form-label">Masukan File BAI</label>
		        ...
		        <div class="form-group row">
		          <label class="col-sm-3 col-form-label">Masukan File Testcom</label>
		          <div class="col-sm-9">
								<div class="custom-file">
									<input type="file" class="custom-file-input" name="berkas[]">
									<label class="custom-file-label" for="inputGroupFile01">Masukan File PDF</label>
		        ...
		        <div class="form-group row">
					<label class="col-sm-3 col-form-label">Masukan Tanggal</label>
					<div class="col-sm-9">
						<div class="input-group mb-3 p-1 ">
									<div class="input-group-prepend">
										<span class="input-group-text bg-info text-white" id="basic-addon1"><i class="fas fa-calendar-alt"></i></span>
									</div>
									<input type="text" class="form-control" id="tanggal" name="tanggal" placeholder="klik disini" 
