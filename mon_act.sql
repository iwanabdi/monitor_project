...
(1, 'mikrotik rb2011', 'mikrotik', 9, '9-1', 7, '2020-10-05', 7, '2020-11-17', 0, '0000-00-00', 1),
(2, 'drop wire', 'fiberhome', 1000, '9-4', 5, '2020-10-05', 0, '0000-00-00', 0, '0000-00-00', 1),
(3, 'access point ', 'unifi', 3, '5-6', 7, '2020-10-06', 7, '2020-11-17', 0, '0000-00-00', 1);
...
('PA-ACT-2011-0003', 3, 9, NULL, NULL, 0, 9, 6, NULL, '112020B00003', '6000000008', 1, '2020-11-17', 7, '2020-11-17', 7, NULL, NULL, 1, NULL);
...
--
ALTER TABLE `dstg`
  MODIFY `id_dstg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `hgi`
--
ALTER TABLE `hgi`
  MODIFY `gi_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `hreservasi`
  MODIFY `reservasi_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `pekerjaan`
  MODIFY `pekerjaan_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
