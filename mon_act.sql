...
MySQL - 5.5.5-10.1.37-MariaDB : Database - mon_act
*********************************************************************
*/
...
insert  into `alamat`(`alamat_id`,`jalan`,`kota`,`provinsi`,`negara`,`koordinat`,`type`,`kontak`,`no_telp`,`create_on`,`create_by`,`update_on`,`update_by`,`delete_on`,`delete_by`,`status`,`customer_id`) values (1,'ketintang','surabaya','jawa timur','indonesia','12312131313',0,'roni','12313','0000-00-00',1,'2020-10-05',7,'0000-00-00',0,1,2),(2,'maospati','sidoarjo','jawa timur','indonesia','-7.123, 114.3543',2,'alex','123','2020-10-05',7,'2020-10-05',7,'0000-00-00',0,1,3),(4,'mall','malang','jawa timur','indonesia','-7',2,'bambang','123','2020-10-05',7,'2020-10-06',7,'0000-00-00',0,1,3),(5,'blitar','blitar','jawa timur','indonesia','-8,413',2,'marvel','8987','2020-10-06',7,'0000-00-00',0,'2020-10-06',7,0,3),(6,'mall','malang','jawa timur','indonesia','-7.12313142,112.1231345',0,'ara','09898','2020-10-06',7,'2020-10-06',7,'2020-10-06',7,0,2),(8,'Samsat Kediri Kota Jalan Anggrek','Kota Kediri','Jawa Timur','Indonesia','-7.123, 114.3543',2,'adi','7655998771','2020-11-17',7,'0000-00-00',0,'0000-00-00',0,1,3),(9,'Samsat Jombang Jalan Arjomulyo','Kabupaten Jombang','Jawa Timur','Indonesia','-7.12313142,112.1314',2,'doni','88754331321','2020-11-17',7,'0000-00-00',0,'0000-00-00',0,1,3);
...
insert  into `customer`(`customer_id`,`nama_customer`,`phone`,`fax`,`alamat`,`email`,`npwp`,`create_on`,`create_by`,`update_on`,`update_by`,`delete_on`,`delete_by`,`status`) values (1,'aaaaaa','','1111111','surabayaaaa','intiland@gmail.comaa','2147483647','0000-00-00',1,'0000-00-00',0,'2020-10-03',0,0),(2,'rene','678','09888','mana yo','mana@gmail.com','9878','0000-00-00',1,'2020-10-05',0,'0000-00-00',0,1),(3,'dispenda','031','031','manyar','dispenda@dispenda.com','12314','2020-10-05',7,'0000-00-00',0,'0000-00-00',0,1),(4,'holand','123476','2346','malang malang lmang blitar malang lmang blitar','holan@holan.com','2147483647','2020-10-06',7,'2020-10-06',0,'0000-00-00',0,1);
...
CREATE TABLE `dgi` (
  ...
  PRIMARY KEY (`gi_no`,`material_id`,`serial_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `dgi` */

insert  into `dgi`(`gi_no`,`material_id`,`serial_number`,`qty`,`create_on`,`create_by`,`update_on`,`update_by`) values (1,1,'123',1,'2020-11-17',7,'0000-00-00',0),(1,3,'123',1,'2020-11-17',7,'0000-00-00',0),(1,3,'345',1,'2020-11-17',7,'0000-00-00',0),(2,1,'1234',1,'2020-11-17',7,'0000-00-00',0),(3,1,'1234',1,'2020-11-17',7,'0000-00-00',0),(3,3,'345',1,'2020-11-17',7,'0000-00-00',0),(3,3,'789',1,'2020-11-17',7,'0000-00-00',0),(4,1,'123',1,'2020-11-17',7,'0000-00-00',0),(4,3,'123',1,'2020-11-17',7,'0000-00-00',0),(6,1,'12345',1,'2020-11-17',7,'0000-00-00',0),(10,1,'12347',1,'2020-11-17',7,'0000-00-00',0),(10,3,'78943',1,'2020-11-17',7,'0000-00-00',0),(12,1,'12342',1,'2020-11-17',7,'0000-00-00',0),(12,1,'143',1,'2020-11-17',7,'0000-00-00',0),(12,3,'1265',1,'2020-11-17',7,'0000-00-00',0),(12,3,'678342',1,'2020-11-17',7,'0000-00-00',0);
...
CREATE TABLE `dgr` (
  ...
  `create_by` int(11) NOT NULL,
  `create_on` date NOT NULL,
  PRIMARY KEY (`gr_no`,`pekerjaan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `dpo` (
  ...
  `create_on` date NOT NULL,
  `create_by` int(11) NOT NULL,
  PRIMARY KEY (`po_no`,`pekerjaan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `dpr` (
  ...
  `create_on` date NOT NULL,
  `create_by` int(11) NOT NULL,
  PRIMARY KEY (`pr_no`,`pekerjaan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `dreservasi` (
  ...
  `update_on` date NOT NULL,
  `update_by` int(11) NOT NULL,
  PRIMARY KEY (`reservasi_no`,`material_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
insert  into `dstg`(`id_dstg`,`project_id`,`no_stg`,`target_date`,`create_on`,`create_by`,`update_on`,`update_by`,`mitra_id`) values (4,'20','1103002/STG/AKV/07/ICON+/2020','2020-11-03','2020-11-03',3,'0000-00-00',0,1),(5,'21','1103003/STG/AKV/07/ICON+/2020','2020-11-03','2020-11-03',3,'0000-00-00',0,2),(6,'PA-ACT-2010-','1103004/STG/AKV/07/ICON+/2020','2020-11-20','2020-11-03',3,'0000-00-00',0,1),(7,'PA-ACT-2010-0004','1103004/STG/AKV/07/ICON+/2020','2020-11-20','2020-11-03',3,'0000-00-00',0,1),(8,'PA-ACT-2011-0001','1103005/STG/AKV/07/ICON+/2020','2020-11-03','2020-11-03',3,'0000-00-00',0,1),(9,'PA-ACT-2011-0002','1117002/STG/AKV/07/ICON+/2020','2020-11-17','2020-11-17',7,'2020-11-17',7,2),(10,'PA-ACT-2011-0003','','0000-00-00','2020-11-17',7,'0000-00-00',0,3);
...
insert  into `hgi`(`gi_no`,`reservasi_no`,`mitra_id`,`create_by`,`create_on`) values (1,10,2,7,'2020-11-17'),(2,10,2,7,'2020-11-17'),(3,10,2,7,'2020-11-17'),(4,11,2,7,'2020-11-17'),(5,13,2,7,'2020-11-17'),(6,13,2,7,'2020-11-17'),(7,12,2,7,'2020-11-17'),(8,12,2,7,'2020-11-17'),(9,12,2,7,'2020-11-17'),(10,12,2,7,'2020-11-17'),(11,14,3,7,'2020-11-17'),(12,14,3,7,'2020-11-17');
...
insert  into `hstg`(`no_stg`,`pegawai_id`,`mitra_id`,`create_on`,`create_by`,`update_on`,`update_by`) values ('1103002/STG/AKV/07/ICON+/2020',2,2,'2020-11-03',3,'0000-00-00',0),('1103003/STG/AKV/07/ICON+/2020',2,2,'2020-11-03',3,'0000-00-00',0),('1103004/STG/AKV/07/ICON+/2020',9,1,'2020-11-03',3,'0000-00-00',0),('1103005/STG/AKV/07/ICON+/2020',2,2,'2020-11-03',3,'0000-00-00',0),('1117002/STG/AKV/07/ICON+/2020',9,2,'2020-11-17',7,'0000-00-00',0);
...
insert  into `laporan`(`laporan_id`,`project_id`,`mitra_id`,`file_pdf`,`file_gdb`,`file_bom`,`create_on`,`create_by`,`update_on`,`update_by`) values (0,0,1,'PA-ACT-2010-_laporan_pdf.pdf','0','0','0000-00-00',1,'0000-00-00',0);
...
insert  into `mitra`(`mitra_id`,`nama_mitra`,`alamat`,`kota`,`no_telp`,`fax`,`email`,`password`,`npwp`,`create_by`,`create_on`,`update_by`,`update_on`,`delete_by`,`delete_on`,`status`) values (1,'mitra','mitra','surabaya','1231','1231','mitra@test.com','92706ba4fd3022cede6d1610b17a0d2d','345345',4,'0000-00-00',1,'0000-00-00',0,'0000-00-00',1),(2,'java','kebonsari','surabaya','2345','12313','java@java.com','93f725a07423fe1c889f448b33d21f46','123213',4,'2020-10-06',4,'0000-00-00',4,'2020-10-06',1),(3,'cahaya alam','graha aparna','surabaya','6797657998','6797657997','admin@cahayaalam.co.id','c464ec5a50c46219854c3079a06b5e04','092542943407000',7,'2020-11-17',7,'0000-00-00',0,'0000-00-00',1);
...
insert  into `pegawai`(`pegawai_id`,`nama_pegawai`,`no_telp`,`email`,`password`,`jabatan`,`create_by`,`create_on`,`update_by`,`update_on`,`delete_by`,`delete_on`,`status`) values (1,'iwan','082244355566','iwan@gmail.com','01ccce480c60fcdb67b54f4509ffdb56',0,0,'0000-00-00',0,'0000-00-00',4,'2020-10-25',0),(2,'pm','123','pm@gmail.com','5109d85d95fece7816d9704e6e5b1279',1,1,'0000-00-00',0,'0000-00-00',0,'0000-00-00',1),(3,'admin','456','admin@gmail.com','21232f297a57a5a743894a0e4a801fc3',2,1,'0000-00-00',1,'0000-00-00',0,'0000-00-00',1),(4,'spv','789','spv@gmail.com','f4984324c6673ce07aafac15600af26e',0,1,'0000-00-00',0,'0000-00-00',0,'0000-00-00',1),(5,'gudang','87','gudang@gmail.com','202446dd1d6028084426867365b0c7a1',3,4,'0000-00-00',0,'0000-00-00',0,'0000-00-00',1),(6,'qc','123','qc@gmail.com','9300c96aaec324987ea5ca6e13a02eda',4,1,'0000-00-00',7,'0000-00-00',0,'0000-00-00',1),(7,'dev','123','dev@test.com','e77989ed21758e78331b20e477fc5582',-1,1,'0000-00-00',0,'0000-00-00',7,'2020-10-06',1),(8,'hansen','353','rolan@email.com','ee21d5f27a8401788147f6f6184ddb11',0,7,'2020-10-06',7,'0000-00-00',7,'2020-10-06',0),(9,'iwan abdillah','123','iwan@gmail.com','01ccce480c60fcdb67b54f4509ffdb56',1,4,'2020-10-25',0,'0000-00-00',0,'0000-00-00',1);
...
insert  into `pekerjaan`(`pekerjaan_id`,`nama_pekerjaan`,`satuan`,`price`,`create_on`,`create_by`,`update_on`,`update_by`,`delete_on`,`delete_by`,`status`) values (1,'penarikan','m',4000,'0000-00-00',1,'2020-09-29',1,'0000-00-00',0,1),(2,'joint','core',8000,'0000-00-00',1,'0000-00-00',0,'2020-09-29',1,0),(3,'joint','u',3000,'2020-12-06',7,'0000-00-00',0,'0000-00-00',0,1);
...
insert  into `product`(`product_id`,`nama_product`,`bandwith`,`satuan`,`status`,`create_on`,`create_by`,`update_on`,`update_by`,`delete_on`,`delete_by`) values (1,'internet',100,'mbps',1,'0000-00-00',1,'2020-10-06',7,'0000-00-00',0),(2,'metronet',20,'mbps',0,'2020-10-06',7,'0000-00-00',0,'2020-10-06',7),(3,'internet',10,'mbps',1,'2020-10-06',7,'0000-00-00',0,'0000-00-00',0),(4,'metronet',2,'mbps',1,'2020-10-06',7,'0000-00-00',0,'0000-00-00',0),(5,'collocation',1,'rack',1,'2020-10-06',7,'0000-00-00',0,'0000-00-00',0),(6,'internet',5,'Mbps',1,'2020-10-06',7,'2020-10-24',1,'0000-00-00',0);
...
insert  into `survey`(`survey_id`,`project_id`,`file_map`,`file_excel`,`mitra_id`,`create_on`,`create_by`,`update_on`,`update_by`) values (1,'20',NULL,'Master_Pegawai(imam).xlsx',NULL,'0000-00-00',0,'0000-00-00',0);
...
/*!50001 DROP TABLE IF EXISTS `po_view` */;

/*!50001 CREATE TABLE  `po_view`(
 `pr_no` int(11) ,
 `mitra_id` int(11) ,
 `mitrapr` varchar(200) ,
 `io_number` text ,
